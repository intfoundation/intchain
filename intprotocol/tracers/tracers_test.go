...
import (
	...
	"github.com/intfoundation/intchain/tests"
)
...
var makeTest = function(tx, rewind) {
  ...
  var block   = intprotocol.getBlock(intprotocol.getTransaction(tx).blockHash);
  var genesis = intprotocol.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.intprotocol.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  intprotocol.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
