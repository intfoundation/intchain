...
func New(mode SyncMode, stateDb intdb.Database, mux *event.TypeMux, chain BlockChain, lightchain LightChain, dropPeer peerDropFn, logger log.Logger) *Downloader {
	if lightchain == nil {
		lightchain = chain
	}
