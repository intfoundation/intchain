...
//		blocks, _ = GenerateChain(params.TestChainConfig, genesis, ipbft.NewFaker(), testdb, 8, nil)
//	)
...
//	chain, _ := NewBlockChain(testdb, nil, params.TestChainConfig, nil, vm.Config{}, nil)
//	defer chain.Stop()
//
...
//		gspec     = &Genesis{Config: params.TestChainConfig}
//		genesis   = gspec.MustCommit(testdb)
//		blocks, _ = GenerateChain(params.TestChainConfig, genesis, nil, testdb, 8, nil)
//	)
//	headers := make([]*types.Header, len(blocks))
...
//		gspec     = &Genesis{Config: params.TestChainConfig}
//		genesis   = gspec.MustCommit(testdb)
//		blocks, _ = GenerateChain(params.TestChainConfig, genesis, nil, testdb, 1024, nil)
//	)
//	headers := make([]*types.Header, len(blocks))
//	seals := make([]bool, len(blocks))
//
