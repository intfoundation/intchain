...
func SetupGenesisBlock(db intdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db intdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db intdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db intdb.Database) *types.Block {
...
func GenesisBlockForTesting(db intdb.Database, addr common.Address, balance *big.Int) *types.Block {
