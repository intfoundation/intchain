...
//	chain, _ := GenerateChain(gspec.Config, genesis, nil, db, b.N, gen)
//
//	// Time the insertion of the new chain.
//	// State and blocks are stored in the same DB.
//	chainman, _ := NewBlockChain(db, nil, gspec.Config, nil, vm.Config{}, nil)
//	defer chainman.Stop()
//	b.ReportAllocs()
//	b.ResetTimer()
...
//			b.Fatalf("error opening database at %v: %v", dir, err)
//		}
//		chain, err := NewBlockChain(db, nil, params.TestChainConfig, nil, vm.Config{}, nil)
//		if err != nil {
