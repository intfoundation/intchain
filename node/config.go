...
import (
	...
	"github.com/intfoundation/intchain/accounts/usbwallet"
...
type Config struct {
	...
	// used in the devp2p node identifier. The instance name of intchain is "intchain". If no
...
// These resources are resolved differently for "intchain" instances.
...
func makeAccountManager(conf *Config) (*accounts.Manager, string, error) {
	...
	if keydir == "" {
		// There is no datadir.
		keydir, err = ioutil.TempDir("", "intchain-keystore")
		ephemeral = keydir
	}
