...
import (
	...
	"github.com/intfoundation/intchain/internal/web3ext"
...
func (c *Console) init(preload []string) error {
	...
	//c.jsre.Run(`var GlobalRegistrar = intprotocol.contract(` + registrar.GlobalRegistrarAbi + `);   registrar = GlobalRegistrar.at("` + registrar.GlobalRegistrarAddr + `");`)
...
func (c *Console) AutoCompleteInput(line string, pos int) (string, []string, string) {
	...
	// E.g. in case of nested lines intprotocol.getBalance(intprotocol.coinb<tab><tab>
	start := pos - 1
	for ; start > 0; start-- {
...
// Welcome show summary of current intchain instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic intchain metadata
	fmt.Fprintf(c.printer, "Welcome to the INT Chain JavaScript console!\n\n")
	c.jsre.Run(`
